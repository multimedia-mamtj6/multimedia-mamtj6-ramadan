...
- `sw.js` - Service worker (cache-first strategy, version `mamtj6-pwa-test-v1.4.6`)
...
- **SW Update Bottom Sheet**: Yellow bottom sheet notification ("Versi baharu tersedia!") slides up from bottom edge when new SW version is detected, with immediate update via `skipWaiting()`
...
- Favicon SVG: `dev.mamtj6.com` (cached by SW)
